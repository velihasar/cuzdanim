...
namespace Business.Helpers
{
    public static class FakeDataMiddlleware
    {
        public static async Task UseDbFakeDataCreator(this IApplicationBuilder app)
        {
            ...
            await mediator.Send(new CreateTranslateInternalCommand { LangId = 1, Code = "AppName", Value = "Flutter Mam" });
            await mediator.Send(new CreateTranslateInternalCommand { LangId = 2, Code = "AppName", Value = "Flutter Mam" });
