...
namespace WebAPI.Controllers
{
    ...
    public class UsersController : BaseApiController
    {
        ...
        {
            return GetResponseOnlyResultMessage(await Mediator.Send(new UpdateUserCommand{UserId = updateUserDto.UserId, UserName = updateUserDto.UserName, Email = updateUserDto.Email,FullName = updateUserDto.FullName, MobilePhones = updateUserDto.MobilePhones, Address = updateUserDto.Address,Notes = updateUserDto.Notes}));
        }
        ...
        {
            var command = new VerifyEmailChangeCommand { Token = token };
            return GetResponseOnlyResultMessage(await Mediator.Send(command));
        }
        ...
        public async Task<IActionResult> CancelEmailChange([FromBody] CancelEmailChangeCommand command)
        {
            return GetResponseOnlyResultMessage(await Mediator.Send(command));
        }
    }
