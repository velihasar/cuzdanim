...
namespace DataAccess.Migrations.Pg
{
    ...
    [Migration("20251203122851_UserPasswordResetEdit")]
    partial class UserPasswordResetEdit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Asset", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Core.Entities.Concrete.AssetType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("ApiUrlKey")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");

                    b.Property<int>("ConvertedAmountType")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Entities.Concrete.ExpenseCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Entities.Concrete.IncomeCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Entities.Concrete.SystemSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("IsBalanceCarriedOver")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Asset", b =>
                {
                    b.HasOne("Core.Entities.Concrete.AssetType", "AssetType")
                        .WithMany("Assets")
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Transaction", b =>
                {
                    b.HasOne("Core.Entities.Concrete.Asset", "Asset")
                        .WithMany("Transactions")
                        .HasForeignKey("AssetId");

                    b.HasOne("Core.Entities.Concrete.ExpenseCategory", "ExpenseCategory")
                        .WithMany("Transactions")
                        .HasForeignKey("ExpenseCategoryId");

                    b.HasOne("Core.Entities.Concrete.IncomeCategory", "IncomeCategory")
                        .WithMany("Transactions")
